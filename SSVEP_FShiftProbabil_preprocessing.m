...
p.subs2use=         [1 3 4 5 6 7 9 10 11 12 13 14 15 18 20:36];%
p.subs2use=         [35 36];%
p.part=             {'b';'c'};
p.events=           {[10 11] [20 21] [30 31] [40 41] [50 51] [60 61]}; % trigger
p.con1name =        'validity';
p.con1label =       {'valid';'valid';'invalid;';'invalid';'neutral';'neutral'};
p.con2name =        'target position';
p.con2label =       {'RDK1';'RDK2';'RDK2';'RDK1';'RDK1';'RDK2'};
p.con2name =        'cued direction';
p.con2label =       {'RDK1';'RDK2';'RDK1';'RDK2';'both';'both'};
p.epoch=            [-2 4.25];
% p.epoch2an=         [-1 3.25]; % not so conservative
p.epoch2an=         [-1 1.5]; % not so conservative
p.epoch2an=         [-1 2]; % not so conservative
p.resample=         256;
