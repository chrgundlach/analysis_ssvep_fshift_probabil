%% parameters
clearvars
F.PathInEEG             = 'E:\work\data\SSVEP_FShift_Probabil\eeg\epoch\';
F.PathInBehavior        = 'E:\work\data\SSVEP_FShift_Probabil\behavior\raw\';
F.PathInSCADS           = 'E:\work\data\SSVEP_FShift_Probabil\eeg\SCADS\';
F.PathOut               = 'E:\work\data\SSVEP_FShift_Probabil\eeg\tfa\'; % with FWHM 0.5
F.subjects              = arrayfun(@(x) sprintf('%02.0f',x),1:30,'UniformOutput',false)';
F.sub2use               = [1 3 4 5 6 7 9 10 11 12];%:53;
