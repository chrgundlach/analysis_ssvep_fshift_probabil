...
%% General Definitions 
clearvars
% p.path=             'E:\work\data\SSVEP_FShift_Probabil\';
% p.bdf_path=         'E:\work\data\SSVEP_FShift_Probabil\eeg\raw\';
% p.path=             'O:\AllgPsy\experimental_data\2023_FShift_Probabil\';
% p.bdf_path=         'O:\AllgPsy\experimental_data\2023_FShift_Probabil\eeg\raw\';
p.path=             'N:\AllgPsy\experimental_data\2023_FShift_Probabil\';
p.bdf_path=         'N:\AllgPsy\experimental_data\2023_FShift_Probabil\eeg\raw\';
...
p.subs2use=         [1 3 4 5 6 7 9 10 11 12 13 14 15 18 20 21 22 23 24 25];%
p.subs2use=         [1 3 4 5 6 7 9 10 11 12 13 14 15 18 20 21 22 23 24 25];%
p.subs2use=         [33 34];%
p.part=             {'b';'c'};
p.events=           {[111] [112] [121] [122] [131] [132] [211] [212] [221] [222] [231] [232]}; % trigger
p.con1name =        'validity';
p.con1label =       {'valid';'valid';'invalid;';'invalid';'neutral';'neutral'; 'valid';'valid';'invalid;';'invalid';'neutral';'neutral'};
p.con2name =        'target position';
p.con2label =       {'RDK1';'RDK1';'RDK1';'RDK1';'RDK1';'RDK1';'RDK2';'RDK2';'RDK2';'RDK2';'RDK2';'RDK2'};
p.con3name =        'event type';
p.con2label =       {'chroma+';'chroma-';'chroma+';'chroma-';'chroma+';'chroma-';'chroma+';'chroma-';'chroma+';'chroma-';'chroma+';'chroma-'};
p.epoch=            [-1 1.5];
